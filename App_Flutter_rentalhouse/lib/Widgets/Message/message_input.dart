...
class ChatInputArea extends StatelessWidget {
  ...
  Future<void> _pickImages(BuildContext context) async {
    ...
    if (images != null && images.isNotEmpty) {
      ...
      // Force rebuild by notifying ChatViewModel
  ...
  Widget build(BuildContext context) {
    ...
    // Wrap in Consumer to rebuild when ChatViewModel notifies (including when images are selected)
            ...
            children: [
              if (editingMessageId != null &&
                  chatViewModel.messages
                      .any((msg) => msg.id == editingMessageId))
                Container(
                  height: 80,
              ...
              // Preview selected images (only when not editing)
              if (editingMessageId == null && selectedImages.isNotEmpty)
                Container(
                  height: 100,
                  margin: const EdgeInsets.only(bottom: 12),
                  child: ListView(

    ...
    try {
      ...
      if (pickedFiles.isNotEmpty) {
        ...
        imagesNotifier.value = [
          ...imagesNotifier.value,
          ...newImages,
        ].take(10).toList(); // Giới hạn tối đa 10 ảnh
      }
    } catch (e) {
    ...
    return ValueListenableBuilder<List<File>>(
      ...
      builder: (context, images, child) {
        return Column(
          ...
          children: [
            _buildSectionTitle(context, 'Hình ảnh mới (${images.length}/10)'),
            Container(
                ...
                children: [
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Image.file(
                                      ...
                                      errorBuilder:
                                        ...
                                        print(
                                            'Local image error: $error for file: ${images[index].path}');
                                        return Container(
                                          width: 90,
                                          height: 110,
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: Text('Thêm ảnh (${images.length}/10)'),
